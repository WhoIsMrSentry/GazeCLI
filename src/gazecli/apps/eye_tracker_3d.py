...
try:
    from gazecli.apps import opengl_sphere as gl_sphere
    GL_SPHERE_AVAILABLE = True
except Exception:
    GL_SPHERE_AVAILABLE = False
    print("OpenGL görselleştirme modülü bulunamadı; 3D render devre dışı.")
...
def selection_gui():
    ...
    tk.Label(root, text="3D Eye Tracker", font=("Arial", 12, "bold")).pack(pady=10)
